...
variable "generate_password" {
  type        = bool
  description = "Wether the password should or not be generated by the module. When the password is not generated by the module, you must provide a secret_id, where the password will be read from."
}
