...
| <a name="input_secret_id"></a> [secret\_id](#input\_secret\_id) | The aws\_secretsmanager\_secret id where the password is stored. This module reads the password and use its value as the master user password. | `string` | n/a | yes |
